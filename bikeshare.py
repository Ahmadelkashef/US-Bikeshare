...
def get_filters():
    ...
    while True :
        city = input("\nWhich city would you like to filter by? kindly enter city as follow New York City, Chicago or Washington?\n")
        if city not in ('New York City', 'Chicago', 'Washington'):
            print("Sorry, I didn't catch that.Noted this is Case Sensetive.please Try again.")
            continue
        else:
            break
...
def trip_duration_stats(df):
    ...
    print('Total travel time:', Total_Travel_Time/86400, " Days") # 86400 = 1 day * 24 hours * 60 min * 60 sec
